...
import angelaImage from '../../assets/images/Langela.png';

/**
 * Componente para cargar imágenes responsive
 */
const ResponsiveImage = ({ mobileImgSrc, desktopImgSrc, alt, className, ...props }) => {
  const [windowWidth, setWindowWidth] = useState(window.innerWidth);
  const [currentSrc, setCurrentSrc] = useState(windowWidth <= 768 ? mobileImgSrc : desktopImgSrc);
  ...
  const handleError = useCallback(() => {
    ...
    setError(true);
    setLoading(false);
    // Intentar con URL fallback si es necesario
    if (currentSrc !== "https://mrxhuang.github.io/angela-sophia-psicologia/assets/Langela-B9r7IvgV.png") {
      setCurrentSrc("https://mrxhuang.github.io/angela-sophia-psicologia/assets/Langela-B9r7IvgV.png");
    }
  }, [currentSrc]);
    ...
    >
      ...
      <div className="container mx-auto px-4 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-10 items-center mt-8 sm:mt-10">
          ...
          >
            ...
            >
              <div className="text-center">
                <span className="block text-xl md:text-2xl font-bold text-primary-600">Empatía</span>
                <span className="text-neutral-600 text-sm sm:text-base">Enfoque personalizado</span>
              </div>
              <div className="text-center">
                <span className="block text-xl md:text-2xl font-bold text-primary-600">Innovación</span>
                <span className="text-neutral-600 text-sm sm:text-base">Técnicas actualizadas</span>
              </div>
              <div className="text-center">
                <span className="block text-xl md:text-2xl font-bold text-primary-600">Compromiso</span>
                <span className="text-neutral-600 text-sm sm:text-base">Con tu bienestar</span>
              </div>
            </motion.div>
            
            <motion.div variants={itemVariants}>
              <h4 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Formación académica</h4>
              <ul className="space-y-2 mb-4 sm:mb-6">
                <li className="flex items-start">
                  ...
                  <span className="text-sm sm:text-base">Licenciatura en Psicología - Universidad Católica de Pereira</span>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-600 mt-0.5 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-sm sm:text-base">Formación continua en Terapia Cognitivo-Conductual</span>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-600 mt-0.5 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-sm sm:text-base">Seminarios especializados en Manejo del Estrés y Ansiedad</span>
                </li>
              </ul>
            </motion.div>
          </motion.div>
          ...
          <div className="relative h-[280px] sm:h-[320px] md:h-[400px] lg:h-[450px] max-w-xs sm:max-w-sm mx-auto lg:mx-0 rounded-2xl overflow-hidden order-2 lg:order-1 mb-6 lg:mb-0">
            ...
            {/* Decoración */}
            <div className="absolute -bottom-5 -left-5 w-16 h-16 md:w-24 md:h-24 bg-primary-100 rounded-full opacity-70 blur-md"></div>
            <div className="absolute -top-5 -right-5 w-14 h-14 md:w-20 md:h-20 bg-secondary-100 rounded-full opacity-70 blur-md"></div>
          </div>
        </div>
        
        {/* Sección de valores */}
        <div className="mt-10 lg:mt-14">
          <h3 className="text-xl sm:text-2xl font-display font-bold mb-5 sm:mb-6 text-center">Mis valores profesionales</h3>
