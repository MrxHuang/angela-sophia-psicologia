...
import VideoInformativo from "./TikTokVideo";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-10 sm:mt-16 text-center">
          <div className="max-w-3xl mx-auto py-8 sm:py-10 px-6 sm:px-8 rounded-2xl glass">
            <h3 className="text-xl sm:text-2xl font-display font-bold mb-3 sm:mb-4 text-primary-800">
              ¿No estás seguro de qué servicio necesitas?
            </h3>
            <p className="text-neutral-700 mb-6 sm:mb-8 text-base sm:text-lg">
              Agenda una primera sesión gratuita de 40 minutos. Será un espacio
              para conversar sobre tus necesidades, conocernos y comenzar a
              construir un lugar seguro y útil para tu proceso
            </p>
        ...
        <VideoInformativo
          ...
          description="Descubre valiosa información sobre psicología y bienestar emocional en nuestro video informativo"
        />
        {/* Redes Sociales */}
